...
public final class CpuStream : DeviceStream {
    ...
    public func div<TL, TR>(lhs: TL, rhs: TR, result: inout TL) throws where TL : TensorDataView, TR : TensorDataView, TL.Scalar : Numeric, TR.Scalar : Numeric {
    ...
    public func mod<TL, TR>(lhs: TL, rhs: TR, result: inout TL) throws where TL : TensorDataView, TR : TensorDataView, TL.Scalar : Numeric, TR.Scalar : Numeric {
      
    }
    
    public func mul<TL, TR>(lhs: TL, rhs: TR, result: inout TL) throws where TL : TensorDataView, TR : TensorDataView, TL.Scalar : Numeric, TR.Scalar : Numeric {
      
    }
    
    public func neg<T>(x: T, result: inout T) throws where T : TensorDataView, T.Scalar : SignedNumeric {
      
    }
    
    public func notEqual<TL, TR, R>(lhs: TL, rhs: TR, result: inout R) throws where TL : TensorDataView, TR : TensorDataView, R : TensorDataView, TL.Scalar : Comparable, TL.Scalar : Numeric, TR.Scalar : Comparable, TR.Scalar : Numeric, R.Scalar == Bool {
    ...
    public func subtract<TL, TR>(lhs: TL, rhs: TR, result: inout TL) throws where TL : TensorDataView, TR : TensorDataView, TL.Scalar : Numeric, TR.Scalar : Numeric {
